  ...
  return (
    <section className="flex flex-col bg:flex-row bg-footer bg-no-repeat bg-cover h-[250px]  items-center lg:items-start justify-center  p-16 gap-y-10 lg:gap-y-5">
      ...
      <div className="text-white flex items-center  gap-x-5">
        <a href="https://github.com/RajputNiraj" target="_blank">
          <FaGithub size={35} />
        </a>
        <a href="https://www.instagram.com/nirajrajput.__/" target="_blank">
          <FaInstagram size={35} />
        </a>
        <a href="mailto:rajputniraj167@gmail.com" target="_blank">
